  ...
  module Admin
    module Conferences
      ...
      class ImportJob < ApplicationJob
        ...
        def find_institution(params, from_json: false)
          params = JSON.parse(params, symbolize_names: true) if from_json
          Institution.find_by! name: params[:name], city: params[:city]
        end

        def find_room(params, from_json: false, with_institution: nil)
          params = JSON.parse(params, symbolize_names: true) if from_json
        ...
        def find_rooms(params, from_json: false, with_institution: nil)
          params = JSON.parse(params, symbolize_names: true) if from_json
        ...
        def find_dietary_requirements(params, from_json: false)
          params = JSON.parse(params, symbolize_names: true) if from_json
        ...
        def find_room_possessions(params, from_json: false, with_conference: nil)
          params = JSON.parse(params, symbolize_names: true) if from_json
        ...
        def find_presentation_type(params, from_json: false, with_conference: nil)
          params = JSON.parse(params, symbolize_names: true) if from_json
        ...
        def find_delegates(params, from_json: false)
          params = JSON.parse(params, symbolize_names: true) if from_json
        ...
        def find_room_use(params, from_json: false, with_conference: nil)
          params = JSON.parse(params, symbolize_names: true) if from_json
          conference = with_conference || find_conference(params[:conference])
