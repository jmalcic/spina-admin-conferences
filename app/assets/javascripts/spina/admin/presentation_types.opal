...
#
class Spina::Admin::PresentationTypesView
  # We should have <body class="controller-<%= controller_name %>"> in layouts
  def initialize(selector = 'body.controller-spina/admin/presentation_types')
    @selector = selector
  end
...
Spina::Admin::PresentationTypesView.new.setup
