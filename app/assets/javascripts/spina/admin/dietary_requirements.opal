...
#
class Spina::Admin::DietaryRequirementsView
  # We should have <body class="controller-<%= controller_name %>"> in layouts
  def initialize(selector = 'body.controller-spina/admin/dietary_requirements')
    @selector = selector
  end
...
Spina::Admin::DietaryRequirementsView.new.setup
