...
module Spina
  ...
  module Conferences
    ...
    Conference.create institution_id: 2, start_date: '2018-04-09', finish_date: '2018-04-11', room_ids: [4, 5, 6]
    PresentationType.create conference_id: 1, name: 'Plenary', minutes: 80, room_possession_ids: [2]
    PresentationType.create conference_id: 1, name: 'Poster', minutes: 30, room_possession_ids: [3]
    PresentationType.create conference_id: 1, name: 'Oral', minutes: 20, room_possession_ids: [1, 2]
    PresentationType.create conference_id: 2, name: 'Plenary', minutes: 80, room_possession_ids: [5]
    PresentationType.create conference_id: 2, name: 'Poster', minutes: 30, room_possession_ids: [4]
    PresentationType.create conference_id: 2, name: 'Oral', minutes: 20, room_possession_ids: [5, 6]
