  ...
  module Admin
    module Conferences
      class RoomUseTest < ActiveSupport::TestCase
        setup { @room_use = spina_admin_conferences_room_uses :plenary_1_lecture_block_3_uoa_2017 }
        ...
        test 'returns a room name' do
          assert_respond_to @room_use, :room_name
          assert_equal @room_use.room_name.class, String
        end
      end
    end
  end
